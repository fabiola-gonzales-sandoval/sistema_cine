    ...
    >
      <style
        ...
        .ticket-wrapper {
          ...
          mask-image: radial-gradient(circle 8px at 0px 50%, transparent 99%, black 100%),
                      radial-gradient(circle 8px at 100% 50%, transparent 99%, black 100%);
          -webkit-mask-image: 
            radial-gradient(circle 7px at 0px 14px, transparent 99%, black 100%),
            radial-gradient(circle 7px at 0px 38px, transparent 99%, black 100%),
            radial-gradient(circle 7px at 0px 62px, transparent 99%, black 100%),
            radial-gradient(circle 7px at 0px 86px, transparent 99%, black 100%),
            radial-gradient(circle 7px at 0px 110px, transparent 99%, black 100%),
            radial-gradient(circle 7px at 0px 134px, transparent 99%, black 100%),
            radial-gradient(circle 7px at 0px 158px, transparent 99%, black 100%),
            radial-gradient(circle 7px at 0px 182px, transparent 99%, black 100%),
            radial-gradient(circle 7px at 0px 206px, transparent 99%, black 100%),
            radial-gradient(circle 7px at 0px 230px, transparent 99%, black 100%),
            radial-gradient(circle 7px at 0px 254px, transparent 99%, black 100%),
            radial-gradient(circle 7px at 0px 278px, transparent 99%, black 100%),
            radial-gradient(circle 7px at 0px 302px, transparent 99%, black 100%),
            radial-gradient(circle 7px at 0px 326px, transparent 99%, black 100%),
            radial-gradient(circle 7px at 0px 350px, transparent 99%, black 100%),
            radial-gradient(circle 7px at 0px 374px, transparent 99%, black 100%),
            radial-gradient(circle 7px at 0px 398px, transparent 99%, black 100%),
            radial-gradient(circle 7px at 0px 422px, transparent 99%, black 100%),
            radial-gradient(circle 7px at 100% 14px, transparent 99%, black 100%),
            radial-gradient(circle 7px at 100% 38px, transparent 99%, black 100%),
            radial-gradient(circle 7px at 100% 62px, transparent 99%, black 100%),
            radial-gradient(circle 7px at 100% 86px, transparent 99%, black 100%),
            radial-gradient(circle 7px at 100% 110px, transparent 99%, black 100%),
            radial-gradient(circle 7px at 100% 134px, transparent 99%, black 100%),
            radial-gradient(circle 7px at 100% 158px, transparent 99%, black 100%),
            radial-gradient(circle 7px at 100% 182px, transparent 99%, black 100%),
            radial-gradient(circle 7px at 100% 206px, transparent 99%, black 100%),
            radial-gradient(circle 7px at 100% 230px, transparent 99%, black 100%),
            radial-gradient(circle 7px at 100% 254px, transparent 99%, black 100%),
            radial-gradient(circle 7px at 100% 278px, transparent 99%, black 100%),
            radial-gradient(circle 7px at 100% 302px, transparent 99%, black 100%),
            radial-gradient(circle 7px at 100% 326px, transparent 99%, black 100%),
            radial-gradient(circle 7px at 100% 350px, transparent 99%, black 100%),
            radial-gradient(circle 7px at 100% 374px, transparent 99%, black 100%),
            radial-gradient(circle 7px at 100% 398px, transparent 99%, black 100%),
            radial-gradient(circle 7px at 100% 422px, transparent 99%, black 100%);
        }
      ...
      <main className="ticket-wrapper">
        <div className="ticket-border">
          ...
          <div style={{ flex: 1, paddingRight: "24px", position: "relative" }}>
            {/* Línea punteada vertical izquierda */}
            <div
              style={{
                position: "absolute",
                left: "-10px",
            ...
            <div style={{ display: "flex", justifyContent: "center", margin: "10px 0 14px 0" }}>
              <svg viewBox="0 0 160 110" style={{ width: "135px", height: "auto" }}>
                ...
                {/* Base Trapezoidal con gradiente / sombra 3D */}
            ...
            <form onSubmit={handleSubmit}>
              <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "16px", marginBottom: "14px" }}>
                <div>
                  ...
                  <input
                    ...
                    defaultValue="usuario@cine-retro.com"
                    required
                  />
                </div>
              ...
              {/* Orla Barroca Adornada (SVG Vectorial Exacto) */}
          ...
          {/* Lado Derecho (Talonario Perforado) */}
          <div
            style={{
              width: "155px",
