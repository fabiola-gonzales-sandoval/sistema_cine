...
import { useEffect as useEffectSesion } from "react";
...
export default function ProductosPage() {
  ...
  const abrirModalEditar = (p: Producto) => {
    ...
    if (productoEditar) {
      await api(`/productos/${productoEditar.id_producto}`, {
        method: "PUT",
          ...
          <div className="overflow-x-auto">
            <table className="w-full text-sm">
              ...
              <tbody className="divide-y divide-white/5">
                  ...
                  <tr key={p.id_producto} className="hover:bg-white/5 transition-colors">
                    <td className="px-4 py-3 text-gold-400 font-semibold">{p.id_producto}</td>
                    <td className="px-4 py-3 text-white font-medium">{p.nombre_producto}</td>
