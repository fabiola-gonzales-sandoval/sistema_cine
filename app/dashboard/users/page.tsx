...
export default function UsersPage() {
  ...
  const [usuarios, setUsuarios] = useState<Usuario[]>([
    { id: 1, nombre: "Luis", apellido: "Fernandez", telefono: "70511111", correo: "luisf@gmail.com" },
    { id: 2, nombre: "Maria", apellido: "Gomez", telefono: "70622222", correo: "mariag@gmail.com" },
    { id: 3, nombre: "Jose", apellido: "Torrez", telefono: "70733333", correo: "joset@gmail.com" },
    { id: 4, nombre: "Carla", apellido: "Mendoza", telefono: "70844444", correo: "carlam@gmail.com" },
    { id: 5, nombre: "Daniel", apellido: "Lopez", telefono: "70955555", correo: "daniell@gmail.com" },
    { id: 6, nombre: "Fernanda", apellido: "Castro", telefono: "71066666", correo: "fernandac@gmail.com" },
    { id: 7, nombre: "Miguel", apellido: "Salazar", telefono: "71177777", correo: "miguels@gmail.com" },
  ]);
  ...
  const guardarUsuario = (e: React.FormEvent) => {
    ...
    if (usuarioEditar) {
      setUsuarios(
        usuarios.map((u) =>
          u.id === usuarioEditar.id ? { ...u, ...form } : u
        )
      );
    } else {
      const nuevoId = usuarios.length > 0 ? Math.max(...usuarios.map((u) => u.id)) + 1 : 1;
      setUsuarios([...usuarios, { id: nuevoId, ...form }]);
    }
    setModalOpen(false);
  };
